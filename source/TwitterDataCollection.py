...
def writeToCSV(api, collection, numTweets, searchString):
    ...
    for tweet in collection:
        ...
        f = open("/home/aspanier/Desktop/ITIN 9300 - Social Computing/Project/TwitterData/TweetsData.csv", "a")
        writer = csv.writer(f)
...
def checkHeader():
    newFile = False
    try:
        data = pd.read_csv("/home/aspanier/Desktop/ITIN 9300 - Social Computing/Project/TwitterData/TweetsData.csv", nrows=1)
        newFile = False
    except:
        newFile = True
    return newFile
...
def readInKeywords():
    keywords = [];
    with open('/home/aspanier/Desktop/ITIN 9300 - Social Computing/Project/TwitterData/Keywords.txt') as f:
